...
class _CartScreenState extends State<CartScreen> {
  ...
  final List<Map<String, dynamic>> _cartItems = [
    {'id': 1, 'name': 'Telur Gulung Original', 'price': 2500, 'quantity': 2, 'image': 'https://via.placeholder.com/150/FFA500/FFFFFF?text=Telur1'},
    {'id': 2, 'name': 'Telur Gulung Pedas', 'price': 3000, 'quantity': 1, 'image': 'https://via.placeholder.com/150/FF6347/FFFFFF?text=Telur2'},
  ];
                          ...
                          child: Row(
                            children: [
                              ClipRRect(
                                ...
                                child: Image.network(
                                  item['image'] ?? 'https://via.placeholder.com/150/CCCCCC/FFFFFF?text=Produk',
                                  width: 80,
                                  height: 80,
                                  fit: BoxFit.cover,
                                ),
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          // Logika checkout
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Proses Checkout untuk User ${widget.user.nama}!')
                          ));
                        },
